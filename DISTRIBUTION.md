...
```text
Local Codex/Claude/Cursor files -> SQLite/FTS index -> CLI + MCP server -> Codex/Claude/Cursor/other agents
```
...
- Broader Cursor format coverage if Cursor changes composer storage again.
